...
def avoidobstacle():
    ...
    time.sleep(turntime)
    stopmotors()
    distance_left =measure()
    print("Distance left is {distance_left}")
    # Turn right
    print("Right")
    right()
    time.sleep(turntime*2)
    stopmotors()
    distance_right =measure()
    print("Distance right is {distance_right}")
    #Compare distances left and right and pick the longest one
